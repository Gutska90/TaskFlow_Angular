...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">taskflow-angular documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/CreateTaskComponent.html" data-type="entity-link" >CreateTaskComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/TaskManagementComponent.html" data-type="entity-link" >TaskManagementComponent</a>
                            </li>
                            <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/PasswordValidationResult.html" data-type="entity-link" >PasswordValidationResult</a>
                            </li>
                            <li class="link">
